...
%Besides fluoroscopy, intraoperative 3D imaging with the angiography system and its combination with fluoroscopy %evolves as a very important imaging modality enabling the surgeon to navigate in 3D anatomy. \cite{TechnicalConsiderations}
%und noch in \cite{HybridOR} schauen
...
%möglich. \cite{DerDigitaleOperationssaal} Kapritel 2

%TODO
%I. Generation: Operation Room (conventional OR)
%-Stand alone devices only
%-Minimal interfaces
%-Focussing hardware

%II. Generation: Integrated Operation Room (integrated OR)
%-BUS-based interoperability (e. g. SCB)
%-Partly common GUI (e. g. OR1, Endoalpha)
%-Focussing Software and mechatronic

%III. Generation: Digital Operation Room (DOR)
%-IP-based interoperability (e. g. OR1 fusion)
%-Functionality classes (e. g. SMGS, SBW, DOCL, COMM)
%-Focussing process-management (e. g. SPMTM)
...
\textbf{Kardiologie:} %TODO bzw. aus Gefäßchirurgie Cario-vaskual machen???
...
%
%Die Vorteile eines digitalen ORs lassen sich zum einen als technisch messbare
%Kriterien zusammenfassen, wie:
%–– eine Verkürzung von Laufwegen für das Personal durch die Erreichbarkeit der
%meisten Funktionalitäten von jedem beliebigen Punkt (zentral aus dem Sterilbereich,
%zentral vom Schwesternarbeitsplatz, dezentral am Gerät bzw. anderen
%Bedieneinheiten (Wandtableau)),
%–– Reduktion des Aufwandes zur Gewährleistung der Hygiene,
%–– Reduktion der Wechselzeiten für Geräteeinstellungen,
%–– Reduktion von Einstellungsfehlern durch Presets,
%–– Verbesserung der Kommunikationsmöglichkeiten,
%–– Verbesserung der Dokumentation durch Digitalisierung und
%–– Integration von Checklisten. \cite{DerDigitaleOperationssaal} Kapitel 15
%
